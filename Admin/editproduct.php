...
if(isset($_REQUEST['pupdate'])){
    if(($_REQUEST['pid']=="") || ($_REQUEST['pname']=="") || ($_REQUEST['pdop']=="") || ($_REQUEST['pava']=="") ||
    ($_REQUEST['ptotal']=="")|| ($_REQUEST['poriginalcost']=="")|| ($_REQUEST['psellingcost']=="")){
        ...
        $sql = "UPDATE assets_tb SET pname='$pname',pdop='$pdop',pava='$pava',ptotal='$ptotal',poriginalcost='$poriginalcost'
        ,psellingcost='$psellingcost' WHERE pid='$pid'" ;
...
<!-- start 2nd column -->
<div class="col-sm-6 mt-5 mx-3 jumbotron px-4 fw-bold" style="background-color:lightgray; opacity:0.85;">
<h3 class="text-center mt-2 mb-2">Update Product Details</h3>
